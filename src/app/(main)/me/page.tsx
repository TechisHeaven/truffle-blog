...
const page = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="max-w-[100px]  my-2 w-full rounded-full overflow-hidden">
        <Image
          width={100}
          loading="eager"
          height={100}
      ...
      <h1 className="font-semibold text-xl">Phoenix Baker</h1>
      <p className="font-medium text-base">example@gmail.com</p>
